...
def main():
    ...
    summary = {
        ...
        "case": {
            ...
            "source_policy": str(meta.get("source_policy", "")),
            "source_policy_base": str(meta.get("source_policy_base", "")),
            "source_override_applied": bool(meta.get("source_override_applied", False)),
            "source_override_name": str(meta.get("source_override_name", "")),
