...
Write-Host "[zju-geometry] repo_root=$repoRoot"
Write-Host "[zju-geometry] python=$python"
Write-Host "[zju-geometry] report_json=$ReportJson"
Write-Host "[zju-geometry] local_zju_root=$LocalZjuRoot"
Write-Host "[zju-geometry] checkpoint=$Checkpoint"
