param(
    [string]$ModalExe = "",
    [string]$ModalAppName = "vggt-zju-geometry-smplprior-headhair",
    ...
    [string]$ExpName = "zju_smplprior_headhair_a100_longrun",
    [string]$OutputSubdir = "",
    [int]$NumImages = 6,
    [int]$MaxImgPerGpu = 24,
    [int]$AccumSteps = 1,
...
$configName = "zju_vggt_geom_unproject_source_policy_nearestplusuniformtail_rawpool_confdepth_dropworst_gradconfmask_smplprior_headhair_longrun"
